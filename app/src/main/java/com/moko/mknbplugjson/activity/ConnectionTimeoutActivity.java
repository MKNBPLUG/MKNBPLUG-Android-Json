...
import com.moko.mknbplugjson.databinding.ActivityConnectionTimeoutBinding;
...
public class ConnectionTimeoutActivity extends BaseActivity<ActivityConnectionTimeoutBinding> {
    ...
    public void onMQTTMessageArrivedEvent(MQTTMessageArrivedEvent event) {
        ...
        if (msgCommon.msg_id == MQTTConstants.READ_MSG_ID_CONNECTION_TIMEOUT) {
            ...
            mBind.etConnectionTimeout.setText(String.valueOf(connectionTimeout.timeout));
        }
    ...
    private boolean isValid() {
        String connectionTimeoutStr = mBind.etConnectionTimeout.getText().toString();
        if (TextUtils.isEmpty(connectionTimeoutStr)) return false;
        int connectionTimeout = Integer.parseInt(connectionTimeoutStr);
