...
public class UploadDataOptionProActivity extends BaseActivity {
    ...
    CheckBox cbRssi;
    @BindView(R.id.cb_raw_data_adv)
    CheckBox cbRawDataAdv;
    @BindView(R.id.cb_raw_data_rsp)
    CheckBox cbRawDataRsp;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_upload_data_option_pro);
    ...
    public void onMQTTMessageArrivedEvent(MQTTMessageArrivedEvent event) {
        ...
        if (msg_id == MQTTConstants.READ_MSG_ID_UPLOAD_DATA_OPTION_PRO) {
            ...
            cbRawDataAdv.setChecked(result.data.adv == 1);
            cbRawDataRsp.setChecked(result.data.rsp == 1);
        }
    ...
    private void setUploadDataOption() {
        ...
        uploadDataOption.adv = cbRawDataAdv.isChecked() ? 1 : 0;
        uploadDataOption.rsp = cbRawDataRsp.isChecked() ? 1 : 0;
